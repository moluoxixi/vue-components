 ...
 * - Slash commands under `.snow/commands/moluoxixi-*.json` (prompt type)
 ...
 * context, so moluoxixi-start is filtered out of skills/commands (optional
 ...
 * moluoxixi-research remains standalone (no implement/check-specific prelude).
 */
