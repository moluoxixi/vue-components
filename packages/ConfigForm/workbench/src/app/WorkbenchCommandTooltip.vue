...
function commandTarget(target: EventTarget | null): CommandTarget | undefined {
...
function commandContent(target: CommandTarget): string {
...
function show(target: CommandTarget, immediate: boolean): void {
  clearShowTimer()
