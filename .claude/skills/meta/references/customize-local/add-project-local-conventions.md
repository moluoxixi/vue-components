...
```bash
python ./.moluoxixi/scripts/task.py add-context <task> implement ".moluoxixi/spec/backend/error-handling.md" "Error handling conventions"
python ./.moluoxixi/scripts/task.py add-context <task> check ".moluoxixi/spec/backend/error-handling.md" "Review error handling"
```
