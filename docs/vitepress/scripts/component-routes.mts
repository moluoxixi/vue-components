...
export const GENERATED_COMPONENT_ROUTE_MARKER = '<!-- Generated by scripts/generate-component-routes.mts. Do not edit directly. -->'

export function createComponentRouteLocaleOptions(
  locale: DocsLocale,
  sourceDocIncludePrefix: string,
): ComponentRouteLocaleOptions {
...
export function renderGeneratedComponentRoute(content: string): string {
...
export function renderComponentRoute(
  ...
  if (component.searchAliases?.length) {
    content.push(`<span hidden data-doc-search-aliases>${component.searchAliases.map(escapeHtml).join(' ')}</span>`)
  }
