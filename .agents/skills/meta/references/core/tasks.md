...
python .moluoxixi/scripts/task.py create "Child task" --slug child --parent <parent-dir>
```
...
python .moluoxixi/scripts/task.py list --mine
python .moluoxixi/scripts/task.py list --status planning
```
...
```bash
python .moluoxixi/scripts/task.py add-subtask <parent-dir> <child-dir>
```
...
```bash
python .moluoxixi/scripts/task.py remove-subtask <parent-dir> <child-dir>
```
...
```bash
python .moluoxixi/scripts/task.py set-branch <dir> <branch>
python .moluoxixi/scripts/task.py set-base-branch <dir> <branch>
python .moluoxixi/scripts/task.py set-scope <dir> <scope>
python .moluoxixi/scripts/task.py add-context <dir> <jsonl> <path> [reason]
python .moluoxixi/scripts/task.py validate <dir>
python .moluoxixi/scripts/task.py list-context <dir>
python .moluoxixi/scripts/task.py list-archive [month]
python .moluoxixi/scripts/task.py create-pr [dir] [--dry-run]
```
...
```bash
python .moluoxixi/scripts/get_context.py                      # Default text (full context)
python .moluoxixi/scripts/get_context.py --json                # Default JSON
python .moluoxixi/scripts/get_context.py --mode record         # Record text (my tasks focus)
python .moluoxixi/scripts/get_context.py --mode record --json  # Record JSON
```
