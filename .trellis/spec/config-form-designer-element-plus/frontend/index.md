# Config Form Designer Element Plus Frontend Guidelines

## Overview

These guidelines route changes in `config-form-designer-element-plus`'s frontend layer to the repository
...
| [Studio Domain Contracts](../../config-form/frontend/studio-domain-contracts.md) | Target Dataset projection, semantic trigger, visual-property, and resolver boundaries | Target contract |
...
- Read [Studio Domain Contracts](../../config-form/frontend/studio-domain-contracts.md) before implementing Dataset materials, semantic triggers, or target Studio capabilities; current `optionResolver` is not Dataset.
