...
Add a new `/moluoxixi:my-command` command.
...
|------|--------|----------|
| `.claude/commands/moluoxixi/my-command.md` | Create | Yes |
...
Create `.claude/commands/moluoxixi/my-command.md`:
...
**Note**: Cursor commands don't have the `moluoxixi:` prefix.

---

## Step 3: Document in project-local
...
1. Run the command: `/moluoxixi:my-command`
