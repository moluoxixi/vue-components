...
testNestedMaterials({
  prefix: 'element',
  createRegistry: createElementPlusDesignerRegistry,
  capabilities: ELEMENT_PLUS_DESIGNER_MATERIAL_REGISTRY,
  inputSelector: 'input.el-input__inner',
})
testNestedMaterials({
  prefix: 'antd',
  createRegistry: createAntdVueDesignerRegistry,
  capabilities: ANTD_VUE_DESIGNER_MATERIAL_REGISTRY,
