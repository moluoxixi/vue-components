...
```bash
python3 .moluoxixi/scripts/get_developer.py
# Output: taosu
```
...
```bash
python3 .moluoxixi/scripts/add_session.py "Session summary"
```
...
```bash
python3 .moluoxixi/scripts/task.py set-branch <task-dir> <branch-name>
```
...
```bash
cd /path/to/project
python3 .moluoxixi/scripts/init_developer.py john-doe
```
...
```bash
# Create task
python3 .moluoxixi/scripts/task.py create "Add user login" --slug add-login

# Initialize context for fullstack work
python3 .moluoxixi/scripts/task.py init-context \
  .moluoxixi/tasks/01-31-add-login-john-doe fullstack

# Start task
python3 .moluoxixi/scripts/task.py start \
...
```bash
python3 .moluoxixi/scripts/add_session.py "Implemented login form, pending API integration"
```

### Archive Completed Task

```bash
python3 .moluoxixi/scripts/task.py archive \
  .moluoxixi/tasks/01-31-add-login-john-doe
```
