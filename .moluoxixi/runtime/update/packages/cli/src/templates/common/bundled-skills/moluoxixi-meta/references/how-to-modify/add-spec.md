...
```bash
python3 ./.moluoxixi/scripts/task.py add-context <task> implement ".moluoxixi/spec/mobile/index.md" "Mobile guidelines"
python3 ./.moluoxixi/scripts/task.py add-context <task> check ".moluoxixi/spec/mobile/architecture.md" "Architecture review rules"
```
