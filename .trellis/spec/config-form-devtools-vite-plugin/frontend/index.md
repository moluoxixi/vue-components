# Config Form Devtools Vite Plugin Frontend Guidelines

## Overview

These guidelines route changes in `config-form-devtools-vite-plugin`'s frontend layer to the repository
...
| [ConfigForm Product Boundaries](../../config-form/frontend/product-boundaries.md) | Runtime-first public API and release contracts | Ready |
