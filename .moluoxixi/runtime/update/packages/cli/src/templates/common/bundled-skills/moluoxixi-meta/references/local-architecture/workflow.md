...
`.moluoxixi/workflow.md` is the Moluoxixi workflow source of truth inside the user project. An AI does not need Moluoxixi source code to understand how the current project should move tasks forward; this file is enough.
...
- Platforms without sub-agent support: the main session reads skills such as `moluoxixi-before-dev`, then executes directly.
...
- skills, such as `moluoxixi-brainstorm` and `moluoxixi-check`.
