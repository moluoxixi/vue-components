...
Detailed guide on Moluoxixi feature availability across different AI coding platforms.

---

## Overview

Moluoxixi is designed primarily for **Claude Code** but provides partial support for **Cursor**. Future support for **OpenCode** is under consideration.
...
|---------|----------|-------------|
| Workspace system | `.moluoxixi/workspace/` | Journals, session history |
| Task system | `.moluoxixi/tasks/` | Task tracking, requirements |
| Spec system | `.moluoxixi/spec/` | Coding guidelines |
...
| Developer identity | `.moluoxixi/.developer` | Who is working |
| Current task | `.moluoxixi/.runtime/sessions/` | Session-scoped active task state |
...
For teams using Cursor, here's how to get partial Moluoxixi benefits:
...
```
1. Session Start
   - Read .moluoxixi/workflow.md
   - Read relevant specs from .moluoxixi/spec/
...
| Moluoxixi Version | Claude Code | Cursor | OpenCode |
|-----------------|-------------|--------|----------|
...
├── YES → Full Moluoxixi support (Claude Code)
