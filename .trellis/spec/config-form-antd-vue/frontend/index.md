# Config Form Antd Vue Frontend Guidelines

## Overview

These guidelines route changes in `config-form-antd-vue`'s frontend layer to the repository
...
| [ConfigForm Product Boundaries](../../config-form/frontend/product-boundaries.md) | Runtime-first host listener and adapter dependency contracts | Ready |
