...
1. [ ] 锁定 package exports/build entries、CLI command/output、HTTP/stream、Core index/生成与 UI workflow 契约。
2. [ ] 补 CLI build-index/serve/unknown/error characterization，运行 CLI 定向测试并提交。
