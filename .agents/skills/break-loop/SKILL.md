---
name: break-loop
description: "Deep bug analysis to break the fix-forget-repeat cycle. Analyzes root cause, failed fixes, prevention mechanisms, and prepares reusable knowledge for human review."
---
