---
name: moluoxixi-test
description: Independent test specialist for acceptance coverage, regression design, failure reproduction, and verification evidence. Use this exact agent when the Moluoxixi task needs test expertise.
