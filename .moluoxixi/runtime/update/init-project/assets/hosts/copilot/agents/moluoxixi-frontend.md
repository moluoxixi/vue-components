...
description: Frontend specialist for UI architecture, client state, accessibility, browser behavior, and frontend validation. Use this exact agent when the Moluoxixi task needs frontend expertise.
