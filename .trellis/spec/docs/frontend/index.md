...
These guidelines route changes in `docs`'s frontend layer to the repository
...
| [Documentation Structure Supplement](./documentation-structure.md) | Package-specific contract | Ready |
