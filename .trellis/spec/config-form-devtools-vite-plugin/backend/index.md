# Config Form Devtools Vite Plugin Backend Guidelines

## Overview

These guidelines route changes in `config-form-devtools-vite-plugin`'s backend layer to the repository
