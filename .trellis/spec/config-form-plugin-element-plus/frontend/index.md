# Config Form Plugin Element Plus Frontend Guidelines

## Overview

These guidelines route changes in `config-form-plugin-element-plus`'s frontend layer to the repository
