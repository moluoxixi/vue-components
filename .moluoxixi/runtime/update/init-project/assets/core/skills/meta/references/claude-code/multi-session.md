...
```bash
python3 .moluoxixi/scripts/multi_agent/start.py <task-dir>
```
...
**Example**:
```bash
python3 .moluoxixi/scripts/multi_agent/start.py .moluoxixi/tasks/01-31-add-login-taosu
...
```bash
# Overview
python3 .moluoxixi/scripts/multi_agent/status.py

# Detailed view
python3 .moluoxixi/scripts/multi_agent/status.py --detail <task-name>

# Watch mode
python3 .moluoxixi/scripts/multi_agent/status.py --watch <task-name>

# View logs
python3 .moluoxixi/scripts/multi_agent/status.py --log <task-name>

# Show registry
python3 .moluoxixi/scripts/multi_agent/status.py --registry
```
...
```bash
python3 .moluoxixi/scripts/multi_agent/create_pr.py [--dry-run]
```
...
```bash
# Specific worktree
python3 .moluoxixi/scripts/multi_agent/cleanup.py <branch-name>

# All merged worktrees
python3 .moluoxixi/scripts/multi_agent/cleanup.py --merged

# All worktrees (with confirmation)
python3 .moluoxixi/scripts/multi_agent/cleanup.py --all
```
...
```bash
# Create task
python3 .moluoxixi/scripts/task.py create "Add login" --slug add-login

# Configure
python3 .moluoxixi/scripts/task.py init-context <task-dir> fullstack
python3 .moluoxixi/scripts/task.py set-branch <task-dir> feature/add-login
...
```bash
python3 .moluoxixi/scripts/multi_agent/status.py --watch add-login
```
...
# Cleanup
python3 .moluoxixi/scripts/multi_agent/cleanup.py feature/add-login
```
...
```bash
# Session 1
python3 .moluoxixi/scripts/multi_agent/start.py .moluoxixi/tasks/01-31-add-login

# Session 2 (immediately)
python3 .moluoxixi/scripts/multi_agent/start.py .moluoxixi/tasks/01-31-fix-api

# Session 3
python3 .moluoxixi/scripts/multi_agent/start.py .moluoxixi/tasks/01-31-update-docs
