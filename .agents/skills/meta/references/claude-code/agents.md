...
Documentation for the Moluoxixi agent system - specialized AI agents for different development phases.

---

## Overview

Moluoxixi uses **specialized agents** for different tasks. Each agent has specific capabilities, restrictions, and context injection.
...
3. For each phase:
   ...
   - create-pr → Bash("python ... create_pr.py")
```
...
inject-subagent-context.py runs
            ...
            │   {"file": ".moluoxixi/spec/cli/backend/index.md", "reason": "..."}
...
### Task Workflow (from /moluoxixi:start)
...
```jsonl
{"file": ".moluoxixi/spec/my-spec.md", "reason": "My agent spec"}
```
