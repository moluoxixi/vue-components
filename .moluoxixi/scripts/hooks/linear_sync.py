...
Usage (called automatically by task.py hooks):
    python .moluoxixi/scripts/hooks/linear_sync.py create
    python .moluoxixi/scripts/hooks/linear_sync.py start
    python .moluoxixi/scripts/hooks/linear_sync.py archive

Manual usage:
    TASK_JSON_PATH=.moluoxixi/tasks/<name>/task.json python .moluoxixi/scripts/hooks/linear_sync.py sync
