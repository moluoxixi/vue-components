...
```bash
python ./.moluoxixi/scripts/task.py create "<child title>" --slug <child-slug> --parent <parent-dir>
```
...
```bash
python ./.moluoxixi/scripts/task.py create "<title>" --slug <slug>
python ./.moluoxixi/scripts/task.py start <task>
python ./.moluoxixi/scripts/task.py current --source
python ./.moluoxixi/scripts/task.py add-context <task> implement <file> <reason>
python ./.moluoxixi/scripts/task.py validate <task>
python ./.moluoxixi/scripts/task.py finish
python ./.moluoxixi/scripts/task.py archive <task>
```
