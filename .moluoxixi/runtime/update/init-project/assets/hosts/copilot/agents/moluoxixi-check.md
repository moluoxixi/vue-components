...
description: Moluoxixi quality check agent. Use this exact agent for Moluoxixi task verification, check.jsonl context injection, and self-fixing code review. Do not use generic/default/generalPurpose agents for Moluoxixi checks.
