...
- Implement exact Gitee tree/edit/commit/issue routes and use the Markdown
  `/blame` line view with a single exact start-line anchor, without reusing
...
- [x] Exact source/edit/commit/issue URLs and the `/blame/...#Lstart` Markdown
      line route are tested and verified on a real project.
...
- [ ] A real public project proves source, line, commit, contributor, edit,
      Issue, and live metadata synchronization behavior.
