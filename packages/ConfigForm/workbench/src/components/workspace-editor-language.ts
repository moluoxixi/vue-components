...
declare module '@moluoxixi/config-form/renderer' {
  ...
  export interface ConfigFormRendererProps<TValues extends ConfigFormValues = ConfigFormValues> {
    ...
    readonlyRender?: (...args: unknown[]) => unknown
    ...
    resolveBinding?: (...args: unknown[]) => unknown
  }
  export interface ConfigFormRendererComponent {
    <TValues extends ConfigFormValues = ConfigFormValues>(props: ConfigFormRendererProps<TValues>): unknown
  }
  export const ConfigFormRenderer: ConfigFormRendererComponent
  export function createConfigFormRendererExpose<TValues extends ConfigFormValues = ConfigFormValues>(): Record<string, unknown>
  export function withConfigFormInstall<T>(component: T): T
}
declare module '@moluoxixi/config-form-headless' {
  ...
  export function defineConfigFormField<TValues extends ConfigFormValues = ConfigFormValues, TComponent = unknown, TFieldAttrs = ConfigFormAttrs, TCellAttrs = ConfigFormAttrs>(field: ConfigFormFieldInput<TValues, TComponent, TFieldAttrs, TCellAttrs>): ConfigFormFieldInput<TValues, TComponent, TFieldAttrs, TCellAttrs>
