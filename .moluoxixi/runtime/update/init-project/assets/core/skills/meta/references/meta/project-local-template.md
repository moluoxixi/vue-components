# Moluoxixi Local Skill Template

Copy this template to create a project-specific `project-local` skill.

---

## How to Use

1. Create directory: `mkdir -p .claude/skills/project-local`
2. Copy the template below to `.claude/skills/project-local/SKILL.md`
...
name: project-local
description: |
  Project-specific Moluoxixi customizations for [PROJECT_NAME].
  This skill documents all modifications made to the vanilla Moluoxixi system.
  Inherits from meta for base architecture documentation.
  Use this skill to understand what's been customized in this project's Moluoxixi setup.
---

# Moluoxixi Local - [PROJECT_NAME]

## Overview

This skill documents all customizations made to Moluoxixi in this project. For vanilla Moluoxixi documentation, see the `meta` skill.

## Base Information

| Field | Value |
|-------|-------|
| Moluoxixi Version | X.X.X |
...
#### /moluoxixi:command-name [ALL]
- **File**: `.claude/commands/moluoxixi/command-name.md`
...
#### Category Name
- **Path**: `.moluoxixi/spec/category-name/`
- **Files**: [list of files]
...
#### spec-name.md
- **Path**: `.moluoxixi/spec/category/spec-name.md`
- **Change**: [what was changed]
- **Date**: YYYY-MM-DD
- **Reason**: [why it was changed]
-->
...
Document any special steps needed when upgrading Moluoxixi.

<!-- Template:
### Upgrade to Moluoxixi X.Y.Z
...
SKILL_DIR=".claude/skills/project-local"
...
name: project-local
description: |
  Project-specific Moluoxixi customizations for PROJECT_NAME_PLACEHOLDER.
  This skill documents all modifications made to the vanilla Moluoxixi system.
  Inherits from meta for base architecture documentation.
---

# Moluoxixi Local - PROJECT_NAME_PLACEHOLDER

## Base Information

| Field | Value |
|-------|-------|
| Moluoxixi Version | $(cat package.json 2>/dev/null | grep version | head -1 | cut -d'"' -f4 || echo "unknown") |
