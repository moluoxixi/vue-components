...
Creates:
- `.moluoxixi/.developer` - Identity file
- `.moluoxixi/workspace/<name>/` - Personal workspace
- `.moluoxixi/workspace/<name>/index.md` - Personal index
- `.moluoxixi/workspace/<name>/journal-1.md` - First journal
...
## Active Work
- Current task: `.moluoxixi/tasks/01-31-add-login-taosu`
- Branch: feature/add-login
