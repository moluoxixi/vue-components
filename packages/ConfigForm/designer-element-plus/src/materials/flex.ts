...
export default defineDesignerMaterialModule({
  ...
  value: {
    material: {
      ...
      createNode: ({ id }) => ({ id, kind: 'container', material: 'element.flex', props: { direction: 'row', wrap: true, gap: 12, justify: 'flex-start', align: 'stretch', itemWidth: 220 }, slots: { default: [] } }),
    },
    locale: {
      title: 'Flex 换行',
      category: '布局',
