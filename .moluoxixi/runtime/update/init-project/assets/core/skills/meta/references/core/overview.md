...
|--------|---------|-------|
| Workspace | Session tracking, journals | `.moluoxixi/workspace/` |
| Tasks | Work item tracking | `.moluoxixi/tasks/` |
| Specs | Coding guidelines | `.moluoxixi/spec/` |
| Commands | Slash command prompts | `.claude/commands/` |
| Scripts | Automation utilities | `.moluoxixi/scripts/` (core subset) |
...
1. Read `.moluoxixi/workflow.md`
2. Read relevant specs from `.moluoxixi/spec/`
3. Run `python3 .moluoxixi/scripts/task.py current --source` for active work
...
| Document | Content |
|----------|---------|
| `files.md` | All files in `.moluoxixi/` with purposes |
