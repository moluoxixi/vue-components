...
description: Independent security specialist for trust boundaries, abuse cases, secrets, authorization, supply chain, and risk review. Use this exact agent when the Moluoxixi task needs security expertise.
