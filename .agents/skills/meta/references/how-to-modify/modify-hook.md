...
def get_additional_context():
    ...
    # Add custom file
    custom_path = os.path.join(repo_root, ".moluoxixi/custom.md")
...
## Step 4: Document in project-local
...
echo '{"subagent_type":"check","output":"test"}' | \
  python .claude/hooks/ralph-loop.py
```
...
files_to_inject = [
    ...
    ".moluoxixi/custom-context.md",  # Add this
]
```
