...
| `docs/.vitepress/vitepress/components/demo/code-fold.ts`  | `src/content/demo/services/code-fold.ts`            | The official indentation-based source folding algorithm is copied into the reusable Demo content module.                                                                                                                                                             |
