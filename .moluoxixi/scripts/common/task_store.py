...
_SEED_EXAMPLE = (
    ...
    "Run `python .moluoxixi/scripts/get_context.py --mode packages` to list available specs. "
...
def has_subagent_platform(repo_root: Path) -> bool:
    """Public planning-gate wrapper around platform detection."""
    return _has_subagent_platform(repo_root)
...
def cmd_create(args: argparse.Namespace) -> int:
    ...
    # load specs via the before-dev skill instead of JSONL.
    seeded_jsonl = False
